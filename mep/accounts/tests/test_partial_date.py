...
class TestPartialDateField(TestCase):
    ...
    def test_from_db_value(self):
        dpf = DatePrecisionField()
        # cast value to date precision
        assert isinstance(dpf.from_db_value(1, None, None), DatePrecision)
        # handle None
    ...
    def test_value_to_string(self):
        ...
        with patch.object(
            imp.date_precision, "value_from_object"
        ) as mock_value_from_object:
            # null
            ...
            assert Imprecise.date_precision.value_to_string(imp) == int(yearmonth)
...
class TestPartialDate(TestCase):
    ...
    def test_parse_date(self):
        ...
        assert partial_date.parse_date("1901-03-05") == (
            datetime.date(1901, 3, 5),
            DatePrecision.year | DatePrecision.month | DatePrecision.day,
        )
        assert partial_date.parse_date("1901-03") == (
            datetime.date(1901, 3, 1),
