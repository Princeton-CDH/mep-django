...
content_editor_perms = {
    "accounts": [
        ...
        "delete_account",
        "add_accountaddress",
        "change_accountaddress",
        "delete_accountaddress",
        "add_borrow",
        "change_borrow",
        "delete_borrow",
        "add_event",
    ...
    "books": [
        ...
        "delete_publisher",
        "add_publisherplace",
        "change_publisherplace",
        "delete_publisherplace",
    ],
    "footnotes": [
        "add_bibliography",
        "change_bibliography",
    ...
    "people": [
        ...
        "change_relationship",
        "delete_relationship",
        "add_relationshiptype",
        "change_relationshiptype",
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.RunPython(
            create_content_editor_group, reverse_code=migrations.RunPython.noop
        ),
    ]
