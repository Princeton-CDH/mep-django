    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('authors', wagtail.core.fields.StreamField([('author', wagtail.snippets.blocks.SnippetChooserBlock(mep.pages.models.Person))], blank=True, help_text='Select or create new people to add as authors.')),
                ('editors', wagtail.core.fields.StreamField([('editor', wagtail.snippets.blocks.SnippetChooserBlock(mep.pages.models.Person))], blank=True, help_text='Select or create new people to add as editors.')),
                ('featured_image', models.ForeignKey(blank=True, help_text='Preview image for landing page list (if supported) and social media.', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to='wagtailimages.Image')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('url', models.URLField(blank=True, default='', help_text='Personal website, profile page, or social media profile pagefor this person.')),
                ('twitter_id', models.CharField(blank=True, default='', help_text='Twitter user ID. Note that this is NOT a username - you canfind yours at http://tweeterid.com/. Will not change if ausername changes.', max_length=100)),
            ],
        ),
