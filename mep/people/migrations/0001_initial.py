# -*- coding: utf-8 -*-
# Generated by Django 1.11.3 on 2017-08-01 15:06
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('code', models.CharField(help_text='ISO two-letter country code', max_length=3, unique=True)),
            ],
            options={
        ...
        migrations.AddField(
            model_name='address',
            name='care_of',
            field=models.ForeignKey(blank=True, help_text='Associated person for "in care of" addresses', null=True, on_delete=django.db.models.deletion.CASCADE, to='people.Person'),
        ),
        migrations.AddField(
            model_name='address',
            name='country',
