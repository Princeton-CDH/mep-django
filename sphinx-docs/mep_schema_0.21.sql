...
) ENGINE=InnoDB AUTO_INCREMENT=7121 DEFAULT CHARSET=utf8;
...
) ENGINE=InnoDB AUTO_INCREMENT=7247 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=8557 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=3470 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=46746 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `footnotes_bibliography` (
  ...
  KEY `footnotes_bibliograp_manifest_id_b30c48b8_fk_djiffy_ma` (`manifest_id`),
  CONSTRAINT `footnotes_bibliograp_manifest_id_b30c48b8_fk_djiffy_ma` FOREIGN KEY (`manifest_id`) REFERENCES `djiffy_manifest` (`id`),
...
CREATE TABLE `footnotes_footnote` (
  ...
  KEY `footnotes_footnote_image_id_a85e099d_fk_djiffy_canvas_id` (`image_id`),
  ...
  CONSTRAINT `footnotes_footnote_image_id_a85e099d_fk_djiffy_canvas_id` FOREIGN KEY (`image_id`) REFERENCES `djiffy_canvas` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=22018 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `pages_contentpage` (
  ...
  KEY `pages_contentpage_featured_image_id_9eb2a5c3_fk_wagtailim` (`featured_image_id`),
  CONSTRAINT `pages_contentpage_featured_image_id_9eb2a5c3_fk_wagtailim` FOREIGN KEY (`featured_image_id`) REFERENCES `wagtailimages_image` (`id`),
...
-- Dump completed on 2019-10-10 14:12:06
