...
) ENGINE=InnoDB AUTO_INCREMENT=7105 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `accounts_event` (
  ...
  KEY `accounts_event_item_id_0a3c364e_fk_books_item_id` (`item_id`),
  ...
  CONSTRAINT `accounts_event_item_id_0a3c364e_fk_books_item_id` FOREIGN KEY (`item_id`) REFERENCES `books_item` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=32321 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=7824 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `books_item` (
  ...
  `item_format_id` int(11) DEFAULT NULL,
  `public_notes` longtext NOT NULL,
  `ebook_url` varchar(200) NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `books_item_mep_id_80ed6238_uniq` (`mep_id`),
  KEY `books_item_item_format_id_bd372512_fk_books_format_id` (`item_format_id`),
  CONSTRAINT `books_item_item_format_id_bd372512_fk_books_format_id` FOREIGN KEY (`item_format_id`) REFERENCES `books_format` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=8407 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `books_item_genres`
--

DROP TABLE IF EXISTS `books_item_genres`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `books_item_genres` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `item_id` int(11) NOT NULL,
  `genre_id` int(11) NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `books_item_genres_item_id_genre_id_f1a00fd2_uniq` (`item_id`,`genre_id`),
  ...
  CONSTRAINT `books_item_genres_item_id_129ada5c_fk_books_item_id` FOREIGN KEY (`item_id`) REFERENCES `books_item` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `books_item_subjects`
--

DROP TABLE IF EXISTS `books_item_subjects`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `books_item_subjects` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `item_id` int(11) NOT NULL,
  `subject_id` int(11) NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `books_item_subjects_item_id_subject_id_8517936e_uniq` (`item_id`,`subject_id`),
  KEY `books_item_subjects_subject_id_f00962a5_fk_books_subject_id` (`subject_id`),
  CONSTRAINT `books_item_subjects_item_id_29e0acba_fk_books_item_id` FOREIGN KEY (`item_id`) REFERENCES `books_item` (`id`),
...
) ENGINE=InnoDB AUTO_INCREMENT=30508 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=9642 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2019-07-08 14:33:36
